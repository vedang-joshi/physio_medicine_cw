...
testDS_Dupont1990_vary_v0_1 = create_pydstools_generator_object(parameter_set=pars_reproduce_paper, name='Dupont1990_reproduce_paper')
testDS_Dupont1990_reproduce_paper = create_pydstools_generator_object(parameter_set=pars_vary_v0_1, name='Dupont1990_reproduce_paper')
testDS_Dupont1990_vary_v0_2 = create_pydstools_generator_object(parameter_set=pars_vary_v0_2, name='Dupont1990_reproduce_paper')
testDS_Dupont1990_vary_v0_3 = create_pydstools_generator_object(parameter_set=pars_vary_v0_3, name='Dupont1990_reproduce_paper')

pts_vary_v0_1 = plotting_traj(generator_object=testDS_Dupont1990_vary_v0_1)
pts_reproduce_paper = plotting_traj(generator_object=testDS_Dupont1990_reproduce_paper)
pts_vary_v0_2 = plotting_traj(generator_object=testDS_Dupont1990_vary_v0_2)
pts_vary_v0_3 = plotting_traj(generator_object=testDS_Dupont1990_vary_v0_3)
...
ax1.plot(pts_vary_v0_1['t'], pts_vary_v0_1['Z'], label='Z trajectory')
ax1.plot(pts_vary_v0_1['t'], pts_vary_v0_1['Y'], label='Y trajectory')

ax2.plot(pts_reproduce_paper['t'], pts_reproduce_paper['Z'], label='Z trajectory')
ax2.plot(pts_reproduce_paper['t'], pts_reproduce_paper['Y'], label='Y trajectory')

ax3.plot(pts_vary_v0_2['t'], pts_vary_v0_2['Z'], label='Z trajectory')
ax3.plot(pts_vary_v0_2['t'], pts_vary_v0_2['Y'], label='Y trajectory')

ax4.plot(pts_vary_v0_3['t'], pts_vary_v0_3['Z'], label='Z trajectory')
ax4.plot(pts_vary_v0_3['t'], pts_vary_v0_3['Y'], label='Y trajectory')

fig.supxlabel('Time (s)')
fig.supylabel('Ca$^{2+}$ in the cytosol ($\mu M$)')
ax1.legend(title='$\\beta$ = 0.301', loc='upper right')
ax2.legend(title='$\\beta$ = 0.201', loc='upper right')
ax3.legend(title='$\\beta$ = 0.601', loc='upper right')
ax4.legend(title='$\\beta$ = 0.801', loc='upper right')
