...
# Set up parameter values changing v0 for each parameter dictionary set.
...
testDS_Dupont1990_vary_v0_1 = create_pydstools_generator_object(parameter_set=pars_vary_v0_1, name='Dupont1990_reproduce_paper')
...
fig.suptitle('Oscillations in cytosolic Ca$^{2 +}$: Varying parameter v0')
...
ax2.plot(pts_vary_v0_1['t'], pts_vary_v0_1['Z'], label='Z trajectory')
ax2.plot(pts_vary_v0_1['t'], pts_vary_v0_1['Y'], label='Y trajectory')
...
ax1.legend(title='v0=1 \u03BC M s$^{-1}$', loc='upper right')
ax2.legend(title='v0=2 \u03BC M s$^{-1}$', loc='upper right')
ax3.legend(title='v0=3 \u03BC M s$^{-1}$', loc='upper right')
ax4.legend(title='v0=5 \u03BC M s$^{-1}$', loc='upper right')
